...
// Force mode, comment out to disable
#define FORCE_MODE 15
...
void loop() {
  ...
  if (rawMode == 1) {
    ...
    // If any of the values are zero, restart the ESP32C3
    // for (int i = 0; i < nDevices * 3; i++) {
    //   if (dataPacket.values[i] == 0) {
    //     Serial.println("Zero value detected, restarting ESP32C3");
    //     delay(500);
    //     restartESP32C3();
    //   }
    // }
