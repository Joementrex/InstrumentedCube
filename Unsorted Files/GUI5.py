...
class CubeVisualizer:
    def __init__(self, serial_port, data_container):
        ...
        # Place the three points on the side faces of the cube 
        # in the same order as the points on the top face
        self.point4 = np.array([1, 0.75, 0.25])
        self.point5 = np.array([1, 0.75, 0.75])
        self.point6 = np.array([1, 0.25, 0.5])
        
        # other face
        self.point7 = np.array([0, 0.75, 0.25])
        self.point8 = np.array([0, 0.75, 0.75])
        self.point9 = np.array([0, 0.25, 0.5])

        # Bottom face of the cube
        self.point10 = np.array([0.25, 0.75, 0])
        self.point11 = np.array([0.75, 0.75, 0])
        self.point12 = np.array([0.5, 0.25, 0])
